...
// нужно разобраться как всё-таки работает this в стрелочных функциях. (см. Буру, урок 9)
// prototype в стрелочных функциях нет, т.к. это легковесные функции и не предназначены для того, чтобы делать из них новые объекты
